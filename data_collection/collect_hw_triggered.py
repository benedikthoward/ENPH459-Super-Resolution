...
and commanded positions.
    ...
    python collect_hw_triggered.py \
...
from api import XPRController, DahengCamera, TRIGGER_LINE2
...
CALIBRATION_DIR = str(Path(__file__).resolve().parent.parent / "calibration_beam_shift" / "data")
# ────────────────────────────────────────────────────────────────────────────

...
def process_run(calib_dir, rep_idx, session_dir, psf_kernel):
    calib_name = os.path.basename(calib_dir)
    out_dir    = os.path.join(session_dir, 'sr_output', calib_name, f'rep{rep_idx:02d}')
    ...
    for session_dir in sessions:
        ...
        for calib_dir in calib_dirs:
            ...
            for rep_idx in rep_indices:
                run_count += 1
                print(f'\n[Run {run_count}] ', end='')
                process_run(calib_dir, rep_idx, session_dir, psf_kernel)
